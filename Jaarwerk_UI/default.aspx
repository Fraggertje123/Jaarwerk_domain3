<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Jaarwerk_UI._default" %>
...
<head runat="server">
    ...
    <style>
        /* Aanvullende aangepaste stijlen */
        #tblContainer {
            margin: 50px auto;
            max-height: 300px;
            overflow-y: auto;
    ...
    font-size: larger;
        ...
        .fixed-header {
            ...
            /* Target the header cells within the fixed header */
            .fixed-header th {
                padding-left: 50px; /* Adjust the left padding to create more space */
                position: sticky;
                top: 0;
        ...
        /* De bootstrap-stijl voor de vaste header */
        .sticky-top {
            position: sticky;
            top: 0;
  ...
  <div class="container-fluid">
    ...
    <form id="form1" runat="server">
        <div class="container ">
            <div class="row">
                <div class="col-md-6">
                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Zoek spelers..."></asp:TextBox>
                </div>
                <div class="col-md-2">
    ...
    <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="Zoek Teams..."></asp:TextBox>
</div>
<div class="col-md-2 Ruimte">
    <asp:Button ID="Button2" runat="server" Text="Zoeken" CssClass="btn btn-primary" OnClick="Button2_Click" />
</div>
            </div>
        </div>

        <div id="tblContainer" >
            <asp:Table ID="tblInfoPlayers" runat="server" CssClass="table table-striped testtest" >
            </asp:Table>
        </div>
    </form>
</body>
